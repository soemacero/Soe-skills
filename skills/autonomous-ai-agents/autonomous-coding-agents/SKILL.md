...
description: "Consolidated class-level playbook for autonomous coding agents."
version: 1.0.0
...
- **Fable 5 Orchestration Playbook (Diego Cardoso Style):** Configura una jerarquía multi-agente con Claude Fable 5 como orquestador principal delegando tareas a ayudantes más económicos (Opus, Sonnet, Codex) para optimizar un 90% el gasto en tokens. Consulta la guía y plantillas en [references/fable-orchestration-playbook.md](references/fable-orchestration-playbook.md).
